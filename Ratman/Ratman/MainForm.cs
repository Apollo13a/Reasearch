        ...
        private void btnStart_Click(object sender, EventArgs e)
        {
            ...
            var model = new LaunchModel
            {
                Launcher = new Launcher
                {
                    ...
                    {
                        new LauncherStage { Number = 1, FullMass = 425353, EmptyMass = 26530, IspAtm = 286, IspVac = 312, ThrustVac = 838.9, Sx = 12, Sy = 256, Cx = 0.3, Cy = 0.3 },
                        new LauncherStage { Number = 2, FullMass = 111560, EmptyMass = 5135, IspAtm = 250, IspVac = 348, ThrustVac = 95.24, Sx = 12, Sy = 100, Cx = 0.3, Cy = 0.3 }
                    },
                    FairingMass = 1750,
